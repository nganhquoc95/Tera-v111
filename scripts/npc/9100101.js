...
function action(mode, type, selection) {
	...
	if (status == 0) {
		...
		if (Math.floor(Math.random() * 300) == 0) {
			...
			var itemList = new Array(2000005, 2022113, 2002018, 1382001, 1050008, 1442017, 1002084,
				1050003, 1002064, 1061006, 1051027, 1442009, 1050056, 1051047, 1050049, 1040080, 1051055,
				1372010, 1422005, 1002143, 1302027, 1061087, 1372003, 1302019, 1051023, 1050054, 1061083,
				1051017, 1002028, 1322010, 1332013, 1050055, 1002245);
